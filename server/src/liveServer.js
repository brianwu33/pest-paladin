/**
 * Deprecated Live Server for Live Streaming
 * Decided to connect the frontend to camera directly
 * This was to do Camera -> Live Server (in the BE) -> frontend
 */
...
io.on("connection", (socket) => {
  ...
  socket.on("getReceivers", (callback) => {
    callback(clients); // Send back the list of connected clients
  });
